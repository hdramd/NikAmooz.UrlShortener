...
namespace NikAmooz.UrlShortener.Application.Common.Models
{
    public class Result<T>
    {
        ...
        public static Result<T> SuccessFulObject(ObjectResult success) => new() { ApiResult = success, Success = true };
    ...
    public class Result
    {
        ...
        public static Result SuccessFul(ObjectResult success) => new() { ApiResult = success, Success = true };
